...
Gem::Specification.new do |s|
  s.name = %q{boxgrinder-build-rpm-based-os-plugin}
  s.version = "0.0.1"
  ...
  s.files = [
    ...
    "lib/boxgrinder-build-rpm-based-os-plugin/rpm-dependency-validator.rb",
    "lib/boxgrinder-build-rpm-based-os-plugin/src/appliance.ks.erb",
    "lib/boxgrinder-build-rpm-based-os-plugin/src/base.repo",
    "lib/boxgrinder-build-rpm-based-os-plugin/src/motd.init",
    "spec/kickstart-spec.rb",
    "spec/rpm-based-os-plugin-spec.rb"
  ]
  ...
  s.summary = %q{RPM Based Operating System Plugin}
